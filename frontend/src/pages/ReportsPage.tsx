  ...
  return (
    <PageTransition>
      <SignatureHero
        ...
        title={<>Maintenance <em>History</em></>}
        description="Review stored maintenance artifacts newest first. Opening a record performs no inference, retrieval, Decision Engine execution, or generation."
        variant="history"
        ...
        facts={machines.data &&
          <>
            <span><strong>{machines.data.length}</strong> stored machines available for history</span>
